...
- [ ] Create a forked copy of this project. Check
- [ ] Add your Team Lead as collaborator on Github. Check
- [ ] Clone your OWN version of the repository (Not Lambda's by mistake!). Check
- [ ] Create a new branch: git checkout -b `<firstName-lastName>`. Check
